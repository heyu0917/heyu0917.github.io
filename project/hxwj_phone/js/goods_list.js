$(function(){
	...
	$('.search-before-list li').tap(function(){
		...
		$('.search-nav-list li i').css({'border-top':'.14rem solid #73c640','border-bottom':'none'});
...
function search_after(){
	...
	$('.ranking').tap(function(){
		if(rank_flag){
			...
			$(this).find('i').css({'border-bottom':'.14rem solid #73c640','border-top':'none'});
			...
			$(".ranking-list li").tap(function(){
				...
				$(this).addClass('select').siblings().removeClass('select');
				$('.ranking-wrap').css({'opacity':'0','z-index':'-1'});
				$('.ranking').find('i').css({'border-top':'.14rem solid #73c640','border-bottom':'none'});
				rank_flag = true;
			})
			rank_flag = false;
		}else{
			$('.ranking-wrap').css({'opacity':'0','z-index':'-1'});
			$(this).find('i').css({'border-top':'.14rem solid #73c640','border-bottom':'none'});
			rank_flag = true;
		}
	})
}
...
function screen(){
	...
	$('.type-list li').tap(function(){
		...
		if(!tapStatus){
			...
			$(this).find('span').css({'color':'#73c640','background':'none','border':'1px solid #73c640','padding-left':'.32rem'})
